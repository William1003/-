...
for project_url in tqdm(project_urls[549:]):
    ...
    for li in li_list:
        ...
        if not assetId or not assetProjectId or not assetTitle or not assetToken or not assetUrl or not assetIsWipModel:
